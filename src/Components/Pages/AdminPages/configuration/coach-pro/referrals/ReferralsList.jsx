...
const data = [
    { title: "Jim Jones", referedBy: "Ethan Bond Vaughan", date: 'Sat 13th May', notes: "N/A", phone: '07910423335', status: 'pending' },
    { title: "Jim Jones", referedBy: "Ethan Bond Vaughan", date: 'Sat 13th May', notes: "N/A", phone: '07910423335', status: 'pending' },
    { title: "Jim Jones", referedBy: "Ethan Bond Vaughan", date: 'Sat 13th May', notes: "N/A", phone: '07910423335', status: 'pending' },
    { title: "Jim Jones", referedBy: "Ethan Bond Vaughan", date: 'Sat 13th May', notes: "N/A", phone: '07910423335', status: 'pending' },
];
    ...
    return (
        <>
            <div className="flex justify-between items-center py-4 pb-5">
                <h3 className="font-semibold text-xl">Referral list</h3>
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="bg-[#F5F5F5] border-b border-[#DBDBDB]">
                            <th className="text-[#717073] font-semibold p-4 text-left">Referee Name</th>
                            <th className="text-[#717073] font-semibold p-4 text-left">Telephone</th>
                            <th className="text-[#717073] font-semibold p-4 text-left">Date</th>
                            <th className="text-[#717073] font-semibold p-4 text-left">Referred by</th>
                            <th className="text-[#717073] font-semibold p-4 text-left">Notes</th>
                            <th className="text-[#717073] font-semibold p-4 text-left">Status</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        {data.map((v, index) => (
                            <React.Fragment key={index}>
                                <tr
                                    className={`border-b bg-white border-[#EFEEF2]`}
                                >
                                    <td className="p-4">{v.title}</td>
                                    <td className="p-4">{v.phone}</td>
                                    <td className="p-4">{v.date}</td>
                                    <td className="p-4">{v.referedBy}</td>
                                    <td className="p-4">{v.notes}</td>
                                    <td className="p-4"><span className={`px-3 py-1 rounded-lg text-sm font-medium ${getStatusClasses(v.status)}`}>
                                        {v.status}</span></td>
